...
#
#         Project: lcls-plc-test-kbslit.tsproj
#        PLC name: lcls-plc-dream-kbslit (lcls-plc-dream-kbslit Instance)
# Generated using: pytmc 2.15.2.dev0+g73bd2d9.d20230727
# Project version: unknown
#    Project hash: unknown
#     PLC IP/host: 172.21.148.24
#      PLC Net ID: 172.21.148.24.1.1
...
epicsEnvSet("LOCATION", "PLC:lcls-plc-dream-kbslit" )
...
system("${ADS_IOC_TOP}/scripts/add_route.sh 172.21.148.24 ^172.*$")
...
epicsEnvSet("PREFIX",         "PLC:lcls-plc-dream-kbslit:")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:DREAM:KBSLIT:")
epicsEnvSet("MOTOR_NAME",      "MMS01")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:lcls-plc-dream-kbslit")
dbLoadRecords("save_restoreStatus.db", "P=PLC:lcls-plc-dream-kbslit:")
dbLoadRecords("caPutLog.db", "IOC=$(IOC)")

## TwinCAT task, application, and project information databases ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:lcls-plc-dream-kbslit,IDX=2")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:lcls-plc-dream-kbslit")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:lcls-plc-dream-kbslit,PROJECT=lcls-plc-test-kbslit.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.15.2.dev0+g73bd2d9.d20230727,PLC_HOST=172.21.148.24")

#   Tc2_Standard: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls-plc-dream-kbslit,DEPENDENCY=Tc2_Standard,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls-plc-dream-kbslit,DEPENDENCY=Tc2_System,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls-plc-dream-kbslit,DEPENDENCY=Tc3_Module,VERSION=*,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("lcls-plc-dream-kbslit.db", "PORT=$(ASYN_PORT),PREFIX=PLC:lcls-plc-dream-kbslit:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 129
callbackSetQueueSize(2258)

# Autosave and archive settings:
save_restoreSet_status_prefix("PLC:lcls-plc-dream-kbslit:")
